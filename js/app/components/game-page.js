...
import { enhanceAuthorBlocks } from './author.js?v=7edc54f7';
...
import { renderCard } from './report-card.js?v=8a5df276';
import { loadSearchIndex, searchIndex } from './search.js?v=6342b4ae';

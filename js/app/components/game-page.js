...
import { enhanceAuthorBlocks } from './author.js?v=c9e5c5e4';
...
import { renderCard } from './report-card.js?v=ac0fda7e';
import { loadSearchIndex, searchIndex } from './search.js?v=4e80d1b1';

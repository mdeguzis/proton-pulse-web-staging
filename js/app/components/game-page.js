...
import { enhanceAuthorBlocks } from './author.js?v=942e5c5b';
...
import { renderCard } from './report-card.js?v=573c2063';
import { loadSearchIndex, searchIndex } from './search.js?v=3f7cd76f';
